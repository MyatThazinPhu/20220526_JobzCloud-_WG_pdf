...
namespace jobzcolud.pdf
{
    ...
    public partial class mitsumori1 : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public Boolean flag_page1;

        Boolean fHIDZUKE=false;

        public int pcount;

        public int rmt_pcount1;

        public int rmt_pcount;
        ...
        private void mitsumori1_FetchData(object sender, FetchEventArgs eArgs)
        {
            if (fkyoten != true)
            {
                try
                {
                    if (fINS == 0)
                    {
                        ...
                        for (int rowind = maxrow; rowind < newmaxrow; rowind++)
                        {
                            dbl_m_m.Rows.Add(dbl_m_m.NewRow());
                            dbl_m_m.AcceptChanges();
                            dbl_m_m.Rows[rowind][0] = rowind + 1;
                            dbl_m_m.Rows[rowind]["nINSATSU_GYO"] = "99999";
                            dbl_m_m.Rows[rowind]["sSYOUHIN_R"] = "追加行1";
                        }

                        if (i < dbl_m_m.Rows.Count)
                        {
                            if (dbl_m_m.Rows[i]["fJITAIS"].ToString() == "1" && dbl_m_m.Rows[i]["fJITAIQ"].ToString() == "1")
                            {
                                ChangeFont(f3);
                            }
                            else if (dbl_m_m.Rows[i]["fJITAIS"].ToString() == "1" && dbl_m_m.Rows[i]["fJITAIQ"].ToString() == "0")
                            {
                                ChangeFont(f1);
                            }
                            else if (dbl_m_m.Rows[i]["fJITAIS"].ToString() == "0" && dbl_m_m.Rows[i]["fJITAIQ"].ToString() == "1")
                            {
                                ChangeFont(f2);
                            }
                            else
                            ...
                            //if (fSYOUSAI == true || fRYOUHOU == true)//詳細の場合
                            if (fSYOUSAI == true)//詳細の場合
                            {
                                if (!string.IsNullOrEmpty(dbl_m_m.Rows[i]["nINSATSU_GYO"].ToString()))
                                {
                                    if (dbl_m.Rows[0]["fNO"].ToString() == "1")//行番号手入力の場合
                                    {
                                        Fields["nINSATSU_GYO"].Value = dbl_m_m.Rows[i]["sSETSUMUI"].ToString();
                                    }
                                    else　//行番号自動入力の場合
                                    {
                                        if (dbl_m_m.Rows[i]["nINSATSU_GYO"].ToString() == "0" || dbl_m_m.Rows[i]["nINSATSU_GYO"].ToString() == "99999" || dbl_m_m.Rows[i]["nINSATSU_GYO"].ToString() == "")
                                        {
                                            Fields["nINSATSU_GYO"].Value = "";
                                        }
                                        else
                                        {
                                            int print_no = int.Parse(dbl_m_m.Rows[i]["nINSATSU_GYO"].ToString());
                            ...
                            {
                                if (dbl_m_m.Rows[i]["nINSATSU_GYO"].ToString() == "99999")
                                {
                                    Fields["nINSATSU_GYO"].Value = "";
                                }
                                else
                                {
                                    ...
                                    else　//行番号自動入力の場合
                                    {
                                        ...
                                        int print = n;
                                        string print_format = string.Empty;
                                        if (dbl_m_m.Rows[i]["nSURYO"].ToString() != "0.00" && dbl_m_m.Rows[i]["nSURYO"].ToString() != "" && dbl_m_m.Rows[i]["nSURYO"].ToString() != "0")
                                        {
                                            if (fMIDASHI == false)
                                            {
                                            ...
                                            else
                                            {
                                                if (fINS == 0)
                                                {
                                                    ...
                                                    {
                                                        print_no = int.Parse(dbl_m_m.Rows[i]["nINSATSU_GYO"].ToString());
                                                        if (print_no.ToString().Length <= 2)//99まで
                                                        {
                                                            print_format = "(" + print_no.ToString("00") + ")";
                                                        }
                            ...
                            if (dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "追加行" || dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "追加行1")//行だけ表示
                            {
                                Fields["sSYOUHIN_R"].Value = ""; //内容.仕様----商品名 追加行の場合
                            }
                            else //商品名を表示
                            {
                                Fields["sSYOUHIN_R"].Value = dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString(); //内容.仕様----商品名 
                            }

                            if (dbl_m_m.Rows[i]["nSURYO"].ToString() == "0.00" || dbl_m_m.Rows[i]["nSURYO"].ToString() == "" || dbl_m_m.Rows[i]["nSURYO"].ToString() == "0")   //数量  为空时，数据库默认为：0.00
                            {
                                Fields["nSURYO"].Value = "";
                            ...
                            {
                                string str = Double.Parse(dbl_m_m.Rows[i]["nSURYO"].ToString()).ToString("0.00");//小数点第一位から第二位に変更
                                if (str.EndsWith("00") == true)// 小数点第一位から第二位に変更
                                {
                                    Fields["nSURYO"].Value = Double.Parse(dbl_m_m.Rows[i]["nSURYO"].ToString()).ToString("0");
                                    Fields["nSURYO2"].Value = "";
                                ...
                                else
                                {
                                    ...
                                    else if (Fields["nSURYO2"].Value.ToString() != ".00")//小数点第一位から第二位に変更
                                    {
                                ...
                                Fields["sTANI"].Value = dbl_m_m.Rows[i]["sTANI"].ToString();      //単位

                                if (dbl_m_m.Rows[i]["nTANKA"].ToString() == "0.00")                //単価  
                                {
                                    Fields["nTANKA"].Value = "";
                                }
                                else
                                {
                                    Fields["nTANKA"].Value = dbl_m_m.Rows[i]["nTANKA"].ToString();
                                }
                                if (dbl_m_m.Rows[i]["nSIKIRITANKA"].ToString() == "0.00" || dbl_m_m.Rows[i]["nSIKIRITANKA"].ToString() == "0.0" || dbl_m_m.Rows[i]["nSIKIRITANKA"].ToString() == "0")
                                {
                                    Fields["nSIKIRITANKA"].Value = "";
                                }
                                else
                                {
                                    Fields["nSIKIRITANKA"].Value = dbl_m_m.Rows[i]["nSIKIRITANKA"].ToString();
                                  
                                }

                            }

                            if (dbl_m_m.Rows[i]["nSIKIRIKINGAKU"].ToString() == "0.0000" || dbl_m_m.Rows[i]["nSIKIRIKINGAKU"].ToString() == "0.000" || dbl_m_m.Rows[i]["nSIKIRIKINGAKU"].ToString() == "0.00" || dbl_m_m.Rows[i]["nSIKIRIKINGAKU"].ToString() == "0" || dbl_m_m.Rows[i]["nSIKIRIKINGAKU"].ToString() == "")                //提供金額  
                            {
                                Fields["nKINGAKU"].Value = "";
                            }
                            else
                            {
                                Fields["nKINGAKU"].Value = dbl_m_m.Rows[i]["nSIKIRIKINGAKU"].ToString();
                            }

                            #endregion

                            #region
                            //if (!string.IsNullOrEmpty(dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString()) && dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "追加行"
                            //  //&& ((dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "小計" && dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "計") || dbl_m_m.Rows[i]["sKUBUN"].ToString() == "計"))
                            //  && ((dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "詳細計" && dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "計") || dbl_m_m.Rows[i]["sKUBUN"].ToString() == "計")) //商品名　区分は小計以外

                            if (!string.IsNullOrEmpty(dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString()) && dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "追加行"
                            //&& ((dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "小計" && dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "計") || dbl_m_m.Rows[i]["sKUBUN"].ToString() == "計"))
                            && (dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "詳細計" && dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() != "計"
                            && dbl_m_m.Rows[i]["sKUBUN"].ToString() != "計"))
                            {

                                Syouhinmei();

                            }
                            //else if (dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "計" || dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "小計" || dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "追加行")//計もしくは小計もしくは追加行

                            //else if (dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "計" 
                            //    || dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "詳細計" 
                            //    || dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "追加行")//計もしくは小計もしくは追加行

                            else if (dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "計"
                              || dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "詳細計"
                              || dbl_m_m.Rows[i]["sSYOUHIN_R"].ToString() == "追加行"
                              || dbl_m_m.Rows[i]["sKUBUN"].ToString() == "計")
                            {

                                Syouhinmei_Tsuika(true, i);

                                if (dbl_m_m.Rows[i]["sKUBUN"].ToString() == "計")
                                {
                            ...
                            if (((i == FIRSTMAXROWS + (PageNumber - 1) * MAXROWS - 1) || (i == dbl_m_m.Rows.Count - 1)) && (fICHIRAN == true || fRYOUHOU == false))
                            {
                                LastRow();
                            }
                    ...
                    else
                    {
                        ...
                        for (int rowind = dbl_Min.Rows.Count; rowind < newmaxrow; rowind++)
                        {
                            dbl_Min.Rows.Add(dbl_Min.NewRow());
                            dbl_Min.AcceptChanges();
                            dbl_Min.Rows[rowind][0] = rowind + 1;
                            dbl_Min.Rows[rowind]["sSYOUHIN_R"] = "追加行1";
                        }

                        if (i < newmaxrow)
                        {
                            if (dbl_Min.Rows[i]["fJITAIS"].ToString() == "1" && dbl_Min.Rows[i]["fJITAIQ"].ToString() == "1")
                            {
                                ChangeFont(f3);
                            }
                            else if (dbl_Min.Rows[i]["fJITAIS"].ToString() == "1" && (dbl_Min.Rows[i]["fJITAIQ"].ToString() == "" || dbl_Min.Rows[i]["fJITAIQ"].ToString() == "0"))
                            {
                                ChangeFont(f1);
                            }
                            else if ((dbl_Min.Rows[i]["fJITAIS"].ToString() == "" || dbl_Min.Rows[i]["fJITAIS"].ToString() == "0") && dbl_Min.Rows[i]["fJITAIQ"].ToString() == "1")
                            {
                                ChangeFont(f2);
                            }
                            else
                            ...
                            //if (dbl_Min.Rows[i]["nINSATSU_GYO"].ToString() != "0" && dbl_Min.Rows[i]["nINSATSU_GYO"].ToString() != "")
                            //{
                            //    Fields["nINSATSU_GYO"].Value = dbl_Min.Rows[i]["nINSATSU_GYO"].ToString();
                            ...
                            if (dbl_Min.Rows[i]["nINSATSU_GYO"].ToString() != "0" && dbl_Min.Rows[i]["nINSATSU_GYO"].ToString() != "")
                            {
                                ...
                                //{
                                //    Fields["nINSATSU_GYO"].Value = dbl_Min.Rows[i]["nINSATSU_GYO"].ToString().Replace("(", "").Replace(")", "").TrimStart(new Char[] { '0' })+".";
                            ...
                            else
                            {
                                ...
                                if (dbl_Min.Rows[i]["sKUBUN"].ToString() == "見")
                                {
                                    print_format = print_no.ToString() + ".";
                                    Fields["nINSATSU_GYO"].Value = print_format;
                            ...
                            if (dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "追加行" || dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "追加行1") //行だけ表示 
                            {
                                Fields["sSYOUHIN_R"].Value = ""; //内容.仕様----商品名 追加行の場合
                            }
                            else　//商品名を表示
                            {
                                Fields["sSYOUHIN_R"].Value = dbl_Min.Rows[i]["sSYOUHIN_R"].ToString(); //内容.仕様----商品名 
                            }


                            if (dbl_Min.Rows[i]["nSURYO"].ToString() == "0.00" || dbl_Min.Rows[i]["nSURYO"].ToString() == "" || dbl_Min.Rows[i]["nSURYO"].ToString() == "0")   //数量  为空时，数据库默认为：0.00
                            {
                                Fields["nSURYO"].Value = "";                                      //如果数据库为空，则界面赋值为“”，即空字符串。
                                Fields["nSURYO2"].Value = "";
                                Fields["sTANI"].Value = "";
                                Fields["nTANKA"].Value = "";
                                Fields["nSIKIRITANKA"].Value = "";
                            ...
                            {
                                string str = Double.Parse(dbl_Min.Rows[i]["nSURYO"].ToString()).ToString("0.00");// 小数点第一位から第二位に変更
                                if (str.EndsWith("00") == true)// 小数点第一位から第二位に変更
                                {
                                    Fields["nSURYO"].Value = Double.Parse(dbl_Min.Rows[i]["nSURYO"].ToString()).ToString("0");
                                    Fields["nSURYO2"].Value = "";
                                    LB_nSURYO.OutputFormat = "#,##0";
                                }
                                else
                                ...
                                Fields["sTANI"].Value = dbl_Min.Rows[i]["sTANI"].ToString();      //単位

                                if (dbl_Min.Rows[i]["nTANKA"].ToString() == "0.00")                //単価  
                                {
                                    Fields["nTANKA"].Value = "";
                                }
                                else
                                {
                                    Fields["nTANKA"].Value = dbl_Min.Rows[i]["nTANKA"].ToString();
                                }
                                if (dbl_Min.Rows[i]["nSIKIRITANKA"].ToString() == "0.00" || dbl_Min.Rows[i]["nSIKIRITANKA"].ToString() == "0.0" || dbl_Min.Rows[i]["nSIKIRITANKA"].ToString() == "0")
                                {
                                    Fields["nSIKIRITANKA"].Value = "";
                                }
                                else
                                {
                                    Fields["nSIKIRITANKA"].Value = dbl_Min.Rows[i]["nSIKIRITANKA"].ToString(); 
                                }
                                //............end..........

                            }

                            if (dbl_Min.Rows[i]["nSIKIRIKINGAKU"].ToString() == "0.0000" || dbl_Min.Rows[i]["nSIKIRIKINGAKU"].ToString() == "0.000" || dbl_Min.Rows[i]["nSIKIRIKINGAKU"].ToString() == "0.00" || dbl_Min.Rows[i]["nSIKIRIKINGAKU"].ToString() == "0" || dbl_Min.Rows[i]["nSIKIRIKINGAKU"].ToString() == "")                //提供金額  
                            {
                                Fields["nKINGAKU"].Value = "";
                            }
                            else
                            {
                                Fields["nKINGAKU"].Value = dbl_Min.Rows[i]["nSIKIRIKINGAKU"].ToString();
                            ...
                            #region
                            //if (!string.IsNullOrEmpty(dbl_Min.Rows[i]["sSYOUHIN_R"].ToString()) && dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "追加行"
                            //   //&& ((dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "小計" && dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "計") || dbl_Min.Rows[i]["sKUBUN"].ToString() == "計")) //商品名　区分は小計以外
                            // && ((dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "詳細計" && dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "計") 
                            // || dbl_Min.Rows[i]["sKUBUN"].ToString() == "計")) //商品名　区分は小計以外

                            if (!string.IsNullOrEmpty(dbl_Min.Rows[i]["sSYOUHIN_R"].ToString()) && dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "追加行"
                            //&& ((dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "小計" && dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "計") || dbl_Min.Rows[i]["sKUBUN"].ToString() == "計")) //商品名　区分は小計以外
                            && (dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "詳細計" && dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() != "計"
                            && dbl_Min.Rows[i]["sKUBUN"].ToString() != "計"))
                            {
                                Syouhinmei();
                            }
                            //else if (dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "計" || dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "小計" || dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "追加行")//計もしくは小計もしくは追加行
                            //else if (dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "計" 
                            //    || dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "詳細計" 
                            //    || dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "追加行")//計もしくは小計もしくは追加行

                            else if (dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "計" || dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "詳細計"
                                     || dbl_Min.Rows[i]["sSYOUHIN_R"].ToString() == "追加行"
                                     || dbl_Min.Rows[i]["sKUBUN"].ToString() == "計")
                            {
                                Syouhinmei_Tsuika(false, i);

                                if (dbl_Min.Rows[i]["sKUBUN"].ToString() == "計")
                                {
                                    LB_S_sNAIYOU.Alignment = TextAlignment.Left;
                                }
                            ...
                            #region
                            if (((i == FIRSTMAXROWS + (PageNumber - 1) * MAXROWS - 1) || (i == dbl_Min.Rows.Count - 1)) && (fICHIRAN == true || fRYOUHOU == false))
                            {
                                LastRow();
                            }
        ...
        private void detail_Format(object sender, EventArgs e)
        {
            if (fINS == 0)
            {
                if (dbl_m_m.Rows.Count > 28)
                {
                    if (i >= (FIRSTMAXROWS + (PageNumber - 1) * MAXROWS) && i != dbl_m_m.Rows.Count)
                    {
                ...
                else
                {
                    ...
                    if (i >= (25 + (PageNumber - 1) * 36) && i != dbl_m_m.Rows.Count)
                    {
                        detail.NewPage = NewPage.After;
                    }
                    else
            ...
            {
                if (dbl_Min.Rows.Count > 28)
                {
                    if (i >= (FIRSTMAXROWS + (PageNumber - 1) * MAXROWS) && i != dbl_Min.Rows.Count)
                    {
                        detail.NewPage = NewPage.After;
                    }
                    else
                ...
                else
                {
                    ...
                    if (i >= (25 + (PageNumber - 1) * 36) && i != dbl_Min.Rows.Count)
                    {
                        detail.NewPage = NewPage.After;
                    }
                    else
        ...
        private void pageHeader_BeforePrint(object sender, EventArgs e)
        {
            ...
            if (nPAGECOUNT > 1)
            {
                ...
                else //プレピュー
                {
                    if (fHYOUSI == true)
                    {
                        LB_PAGE1.Text = "(" + (rmt_pcount + k1 + 1) + " / " + nPAGECOUNT.ToString() + ")";
                    }
                    else
                    {
                        LB_PAGE1.Text = "(" + (rmt_pcount + k1) + " / " + nPAGECOUNT.ToString() + ")";
                    }
                    k1++;
                }
            }
        ...
        private void pageFooter_BeforePrint(object sender, EventArgs e)
        {
            ...
            else //プレピュー
            {
                if (fHYOUSI == true)
                {
                    this.LB_PAGE.Text = "(" + (rmt_pcount + k + 1) + " / " + nPAGECOUNT.ToString() + ")";
                }
                else
                {
                    this.LB_PAGE.Text = "(" + (rmt_pcount + k) + " / " + nPAGECOUNT.ToString() + ")";
                }
                k++;
            }
