...
namespace jobzcolud.WebFront
{
    public partial class JC10MitsumoriTouroku : System.Web.UI.Page
    {
        ...
        private void PrintPDF(object sender, EventArgs e)
        {
            ...
            if (fMIDASHI == false && fSYOUSAI == true && CHK_Meisai.Checked == false)//詳細だけ 
            {
                pcount = 0;
                rmt_pcount1 = 0;
                flag_page1 = true;

                mitsumori1 prt4 = new mitsumori1(); // 纵向数据表 type1
                prt4.pcount = pcount;
                prt4.rmt_pcount1 = rmt_pcount1;
                prt4.flag_page1 = flag_page1;
                prt4.tokui_align = "中央";
                prt4.busyo_align = "中央";
                prt4.tantou_align = "";
                if (fSYOUSAI == true)
                {
                    prt4.fSYOUSAI = fSYOUSAI;//詳細チェック出来ると印刷できる
                }
                else
                {
                    prt4.fICHIRAN = true;//詳細のみを印刷できなっかた場合、デフォルトで明細をチェック
                }

                prt4.imagecheck = DDL_Logo.SelectedItem.ToString();
                prt4.HANKO_Check = "欄有り(担当印有り)";
                ...
                //选择 税抜金額
                if (btnZeinuKingaku1.CssClass == "JC10ZeikomiBtnActive")//CB_ZEINUKIKINNGAKU1.Checked == true
                {
                    //frm.fZEINUKIKINNGAKU = true;
                    prt4.fZEINUKIKINNGAKU = true;
                }
                else if (btnZeinuKingaku2.CssClass == "JC10ZeikomiBtnActive") //CB_ZEINUKIKINNGAKU2.Checked == true
                {
                    //frm.fZEINUKIKINNGAKU = false;
                    prt4.fZEINUKIKINNGAKU = false;
                }
                else 
                {
                    prt4.fZEIFUKUMUKIKINNGAKU = true;
                }

                #region 纵向type1打印
                prt4.cMITUMORI = lblcMitumori.Text;
                prt4.picture1.Visible = false;
                prt4.picture2.Visible = false;

                #region toDelete
                //if (RB_TABLE.Checked)//数据表
                //{
                //    prt4.picture1.Visible = false;
                //    prt4.picture2.Visible = false;
                //}
                //else if (RB_TABLE_PIC1.Checked)//为数据表+1张图片
                //{
                //    prt4.picture1.Visible = true;
                //    if (pic1.Equals(""))
                //    {
                //        //prt4.picture1.Image = null;
                //        //20141120 如果图片1为空的话将图片2添加过来
                //        if (pic2 != "")
                //        {
                //            prt4.picture1.Image = Image.FromFile(pic2);
                //        }
                //        //..............end......
                //    }
                //    else
                //    {
                //        prt4.picture1.Image = Image.FromFile(pic1);  //20140828 zww add

                //    }
                //    prt4.picture2.Visible = false;
                //}
                //else if (RB_TABLE_PIC2.Checked)//数据表+2张图片
                //{
                //    prt4.picture1.Visible = true;
                //    if (pic1.Equals(""))
                //    {
                ...
                //        prt4.picture1.Image = Image.FromFile(pic1);//20140828 zww add
                //    }
                //    prt4.picture2.Visible = true;
                //    if (pic2.Equals(""))
                //    {
                //        prt4.picture2.Image = null;
                //    }
                //    else
                //    {
                //        prt4.picture2.Image = Image.FromFile(pic2);//20140828 zww add
                //    }
                //}
                #endregion

                prt4.fSYOUSAI = true;//詳細チェック
                prt4.fICHIRAN = false;//一覧アンチェック
                prt4.fRYOUHOU = false;
                prt4.Run();
                //frm.nMAXPAGE = prt4.nPAGECOUNT.ToString();

                #region toDelete
                //if (prt4.fNEWIMAGE == true)
                //{
                //    PRT_MITUMORI_TATE1IMAGE prtIMAGES = new PRT_MITUMORI_TATE1IMAGE();
                //    prtIMAGES.nPAGE = prt4.nPAGECOUNT.ToString() + " / " + prt4.nPAGECOUNT.ToString();

                //    //add by yamin 20161222 start
                //    if (RB_TABLE.Checked)//数据表
                //    {
                //        prtIMAGES.picture1.Visible = false;
                //        prtIMAGES.picture2.Visible = false;
                //    }
                //    else if (RB_TABLE_PIC1.Checked)//为数据表+1张图片
                //    {
                //        prtIMAGES.picture1.Visible = true;
                //        if (pic1.Equals(""))
                //        {
                //            //prt4.picture1.Image = null;
                //            //20141120 如果图片1为空的话将图片2添加过来
                //            if (pic2 != "")
                //            {
                //                prtIMAGES.picture1.Image = Image.FromFile(pic2);
                //            }
                //            //..............end......
                //        }
                //        else
                //        {
                //            prtIMAGES.picture1.Image = Image.FromFile(pic1);  //20140828 zww add
                ...
                //        if (pic1.Equals(""))
                //        {
                //            prtIMAGES.picture1.Image = null;
                //        }
                //        else
                //        {
                //            prtIMAGES.picture1.Image = Image.FromFile(pic1);//20140828 zww add
                //        }
                //        prtIMAGES.picture2.Visible = true;
                //        if (pic2.Equals(""))
                //        {
                //            prtIMAGES.picture2.Image = null;
                //        }
                //        else
                //        {
                //            prtIMAGES.picture2.Image = Image.FromFile(pic2);//20140828 zww add
                //        }
                //    }
                //    //add by yamin 20161222 end

                //    prtIMAGES.Run();
                //    frm.prt01 = prtIMAGES;
                //    prt4.Document.Pages.Add(prtIMAGES.Document.Pages[0]);
                //    prtIMAGES.Dispose();
                //    prtIMAGES = null;
                //}
                //else
            ...
            else if (fMIDASHI == false && fSYOUSAI == true && CHK_Meisai.Checked == true)//一覧と詳細両方表示 
            {
                pcount = 0;
                rmt_pcount1 = 0;
                ...
                mitsumori1 prt4_p1 = new mitsumori1(); // 纵向数据表 type1

                prt4_p1.pcount = pcount;
                prt4_p1.rmt_pcount1 = rmt_pcount1;
                prt4_p1.flag_page1 = flag_page1;
                prt4_p1.tokui_align = "中央";
                prt4_p1.busyo_align = "中央";
                prt4_p1.tantou_align = "";
                prt4_p1.imagecheck = DDL_Logo.SelectedItem.ToString();
                prt4_p1.HANKO_Check = "欄有り(担当印有り)";
                prt4_p1.fSYOUSAI = false;//詳細チェック
                prt4_p1.fICHIRAN = true;//一覧アンチェック
                prt4_p1.fRYOUHOU = fSYOUSAI;
                prt4_p1.ckyoten = cKyoten; 
                prt4_p1.frogoimage = flagrogo;
                ...
                {
                    //frm.fZEINUKIKINNGAKU = true;
                    prt4_p1.fZEINUKIKINNGAKU = true;
                }
                else if (btnZeinuKingaku2.CssClass == "JC10ZeikomiBtnActive") //CB_ZEINUKIKINNGAKU2.Checked == true
                {
                    //frm.fZEINUKIKINNGAKU = false;
                    prt4_p1.fZEINUKIKINNGAKU = false;
                }
                else
                {
                    prt4_p1.fZEIFUKUMUKIKINNGAKU = true;
                }

                #region 纵向type1打印
                prt4_p1.cMITUMORI = lblcMitumori.Text;
                prt4_p1.picture1.Visible = false;
                prt4_p1.picture2.Visible = false;
                #region toDelete
                //if (RB_TABLE.Checked)//数据表
                //{
                //    prt4_p1.picture1.Visible = false;
                ...
                //        if (pic2 != "")
                //        {
                //            prt4_p1.picture1.Image = Image.FromFile(pic2);
                //        }
                //        //..............end......
                //    }
                //    else
                //    {
                //        prt4_p1.picture1.Image = Image.FromFile(pic1);  //20140828 zww add
                ...
                //    if (pic1.Equals(""))
                //    {
                //        prt4_p1.picture1.Image = null;
                //    }
                //    else
                //    {
                //        prt4_p1.picture1.Image = Image.FromFile(pic1);//20140828 zww add
                //    }
                //    prt4_p1.picture2.Visible = true;
                //    if (pic2.Equals(""))
                //    {
                //        prt4_p1.picture2.Image = null;
                //    }
                //    else
                //    {
                //        prt4_p1.picture2.Image = Image.FromFile(pic2);//20140828 zww add
                //    }
                //}
                #endregion
                prt4_p1.Run();
                ...
                #region toDelete
                //if (prt4_p1.fNEWIMAGE == true)
                //{
                //    PRT_MITUMORI_TATE1IMAGE prtIMAGES = new PRT_MITUMORI_TATE1IMAGE();

                //    if (frm.hyoushi == 1)//表紙がある場合は1plus
                //    {
                //        prtIMAGES.nPAGE = (prt4_p1.nPAGECOUNT_1 + 1).ToString() + " / " + prt4_p1.nPAGECOUNT.ToString();
                //    }
                //    else
                //    {
                //        prtIMAGES.nPAGE = prt4_p1.nPAGECOUNT_1.ToString() + " / " + prt4_p1.nPAGECOUNT.ToString();
                //    }
                ...
                //    prtIMAGES.Run();
                //    frm.prt01 = prtIMAGES;
                //    prt4_p1.Document.Pages.Add(prtIMAGES.Document.Pages[0]);
                //    prtIMAGES.Dispose();
                //    prtIMAGES = null;
                //}
                //else
                ...
                //
                mitsumori1 prt5_p1 = new mitsumori1(); // 纵向数据表 type1
                prt5_p1.pcount = pcount;
                prt5_p1.rmt_pcount1 = rmt_pcount1;
                prt5_p1.flag_page1 = flag_page1;
                prt5_p1.tokui_align = "中央";
                prt5_p1.busyo_align = "中央";
                prt5_p1.tantou_align = "";
                prt5_p1.imagecheck = DDL_Logo.SelectedItem.ToString();
                prt5_p1.HANKO_Check = "欄有り(担当印有り)";
                prt5_p1.fSYOUSAI = fSYOUSAI;//詳細チェック出来ると印刷できる
                prt5_p1.fICHIRAN = false;//一覧アンチェック
                prt5_p1.fRYOUHOU = fSYOUSAI;
                prt5_p1.ckyoten = cKyoten;
                prt5_p1.frogoimage = flagrogo;
                ...
                {
                    //frm.fZEINUKIKINNGAKU = true;
                    prt5_p1.fZEINUKIKINNGAKU = true;
                }
                else if (btnZeinuKingaku2.CssClass == "JC10ZeikomiBtnActive") //CB_ZEINUKIKINNGAKU2.Checked == true
                {
                    //frm.fZEINUKIKINNGAKU = false;
                    prt5_p1.fZEINUKIKINNGAKU = false;
                }
                else
                {
                    prt5_p1.fZEIFUKUMUKIKINNGAKU = true;
                }
                
                #region 纵向type1打印
                prt5_p1.cMITUMORI = lblcMitumori.Text;
                prt5_p1.picture1.Visible = false;
                prt5_p1.picture2.Visible = false;
                #region toDelete
                //if (RB_TABLE.Checked)//数据表
                //{
                //    prt5_p1.picture1.Visible = false;
                ...
                //        if (pic2 != "")
                //        {
                //            prt5_p1.picture1.Image = Image.FromFile(pic2);
                //        }
                //        //..............end......
                //    }
                //    else
                //    {
                //        prt5_p1.picture1.Image = Image.FromFile(pic1);  //20140828 zww add
                ...
                //    if (pic1.Equals(""))
                //    {
                //        prt5_p1.picture1.Image = null;
                //    }
                //    else
                //    {
                //        prt5_p1.picture1.Image = Image.FromFile(pic1);//20140828 zww add
                //    }
                //    prt5_p1.picture2.Visible = true;
                //    if (pic2.Equals(""))
                //    {
                //        prt5_p1.picture2.Image = null;
                //    }
                //    else
                //    {
                //        prt5_p1.picture2.Image = Image.FromFile(pic2);//20140828 zww add
                //    }
                //}
                #endregion
                prt5_p1.Run();
                ...
                #region toDelete
                //if (prt5_p1.fNEWIMAGE == true)
                //{
                //    PRT_MITUMORI_TATE1IMAGE prtIMAGES = new PRT_MITUMORI_TATE1IMAGE();
                //    prtIMAGES.nPAGE = prt5_p1.nPAGECOUNT.ToString() + " / " + prt5_p1.nPAGECOUNT.ToString();
                ...
                //    prtIMAGES.Run();
                //    frm.prt01 = prtIMAGES;
                //    prt5_p1.Document.Pages.Add(prtIMAGES.Document.Pages[0]);
                //    prtIMAGES.Dispose();
                //    prtIMAGES = null;
                //}
                //else
                ...
                if (fSYOUSAI == true)
                {
                    for (int i = 0; i < prt5_p1.Document.Pages.Count; i++)//一覧と詳細両方表示
                    {
                        prt4_p1.Document.Pages.Add(prt5_p1.Document.Pages[i]);
                    }
                }
                ...
                //    if (frm.hyoushi == 1)//表紙がある場合は1plus
                //    {
                //        prtIMAGES.nPAGE = (prt4.nPAGECOUNT_1 + 1).ToString() + " / " + prt4.nPAGECOUNT.ToString();
                //    }
                //    else
                //    {
                //        prtIMAGES.nPAGE = prt4.nPAGECOUNT_1.ToString() + " / " + prt4.nPAGECOUNT.ToString();
                //    }
                ...
                rmt_pcount1 = prt4_p1.nPAGECOUNT;

                mitsumori1 prt5 = new mitsumori1(); // 纵向数据表 type1
                prt5.pcount = pcount;
                prt5.rmt_pcount1 = rmt_pcount1;
                prt5.flag_page1 = flag_page1;
                prt5.tokui_align = "中央";
                prt5.busyo_align = "中央";
                prt5.tantou_align = "";
                prt5.imagecheck = DDL_Logo.SelectedItem.ToString(); 
                prt5.HANKO_Check = "欄有り(担当印有り)";
                prt5.fSYOUSAI = fSYOUSAI;//詳細チェック出来ると印刷できる
                prt5.fICHIRAN = false;//一覧アンチェック
                prt5.fRYOUHOU = fSYOUSAI;
                prt5.ckyoten = cKyoten; //add by yamin 20180925
                prt5.frogoimage = flagrogo; 
                ...
                {
                    //frm.fZEINUKIKINNGAKU = true;
                    prt5.fZEINUKIKINNGAKU = true;
                }
                else if (btnZeinuKingaku2.CssClass == "JC10ZeikomiBtnActive") //CB_ZEINUKIKINNGAKU2.Checked == true
                {
                    //frm.fZEINUKIKINNGAKU = false;
                    prt5.fZEINUKIKINNGAKU = false;
                }
                else
                {
                    prt5.fZEIFUKUMUKIKINNGAKU = true;
                }

                #region 纵向type1打印
                prt5.cMITUMORI = lblcMitumori.Text;

                prt5.picture1.Visible = false;
                prt5.picture2.Visible = false;
                #region toDelete
                //if (RB_TABLE.Checked)//数据表
                //{
                //    prt5.picture1.Visible = false;
                ...
                //        if (pic2 != "")
                //        {
                //            prt5.picture1.Image = Image.FromFile(pic2);
                //        }
                //        //..............end......
                //    }
                //    else
                //    {
                //        prt5.picture1.Image = Image.FromFile(pic1);  //20140828 zww add
                ...
                //    if (pic1.Equals(""))
                //    {
                //        prt5.picture1.Image = null;
                //    }
                //    else
                //    {
                //        prt5.picture1.Image = Image.FromFile(pic1);//20140828 zww add
                //    }
                //    prt5.picture2.Visible = true;
                //    if (pic2.Equals(""))
                //    {
                //        prt5.picture2.Image = null;
                //    }
                //    else
                //    {
                //        prt5.picture2.Image = Image.FromFile(pic2);//20140828 zww add
                //    }
                //}
                #endregion
                prt5.Run();
                ...
                #region toDelete
                //if (prt5.fNEWIMAGE == true)
                //{
                //    PRT_MITUMORI_TATE1IMAGE prtIMAGES = new PRT_MITUMORI_TATE1IMAGE();
                //    prtIMAGES.nPAGE = prt5.nPAGECOUNT.ToString() + " / " + prt5.nPAGECOUNT.ToString();
                ...
                //    prtIMAGES.Run();
                //    frm.prt01 = prtIMAGES;
                //    prt5.Document.Pages.Add(prtIMAGES.Document.Pages[0]);
                //    prtIMAGES.Dispose();
                //    prtIMAGES = null;
                //}
                //else
            ...
            else
            {
                ...
                {
                    if (fMIDASHI == true && fSYOUSAI == true && CHK_Meisai.Checked == true) //見出し、明細、詳細
                    {
                        pcount = 0;
                        rmt_pcount1 = 0;
                        ...
                        #region 見出し
                        mitsumori1 prt4_midashi = new mitsumori1(); // 纵向数据表 type1
                        prt4_midashi.pcount = pcount;
                        prt4_midashi.rmt_pcount1 = rmt_pcount1;
                        prt4_midashi.flag_page1 = flag_page1;
                        prt4_midashi.tokui_align = "中央";
                        prt4_midashi.busyo_align = "中央";
                        prt4_midashi.tantou_align = "";
                        prt4_midashi.imagecheck = DDL_Logo.SelectedItem.ToString();
                        prt4_midashi.HANKO_Check = "欄有り(担当印有り)";
                        prt4_midashi.fSYOUSAI = false;//詳細チェック
                        prt4_midashi.fICHIRAN = false;//一覧アンチェック
                        prt4_midashi.fRYOUHOU = true;
                        prt4_midashi.fMIDASHI = fMIDASHI;//見出しチェック
                        prt4_midashi.ckyoten = cKyoten;
                        prt4_midashi.frogoimage = flagrogo;
                        ...
                        {
                            //frm.fZEINUKIKINNGAKU = true;
                            prt4_midashi.fZEINUKIKINNGAKU = true;
                        }
                        else if (btnZeinuKingaku2.CssClass == "JC10ZeikomiBtnActive") //CB_ZEINUKIKINNGAKU2.Checked == true
                        {
                            //frm.fZEINUKIKINNGAKU = false;
                            prt4_midashi.fZEINUKIKINNGAKU = false;
                        }
                        else
                        {
                            prt4_midashi.fZEIFUKUMUKIKINNGAKU = true;
                        }

                        #region 纵向type1打印
                        prt4_midashi.cMITUMORI = lblcMitumori.Text;

                        prt4_midashi.picture1.Visible = false;
                        prt4_midashi.picture2.Visible = false;
                        ...
                        //else if (RB_TABLE_PIC1.Checked)//为数据表+1张图片
                        //{
                        //    prt4_midashi.picture1.Visible = true;
                        //    if (pic1.Equals(""))
                        //    {
                        //        //prt4.picture1.Image = null;
                        //        //20141120 如果图片1为空的话将图片2添加过来
                        //        if (pic2 != "")
                        //        {
                        //            prt4_midashi.picture1.Image = Image.FromFile(pic2);
                        //        }
                        //        //..............end......
                        //    }
                        //    else
                        //    {
                        //        prt4_midashi.picture1.Image = Image.FromFile(pic1);  //20140828 zww add
                        ...
                        //    if (pic1.Equals(""))
                        //    {
                        //        prt4_midashi.picture1.Image = null;
                        //    }
                        //    else
                        //    {
                        //        prt4_midashi.picture1.Image = Image.FromFile(pic1);//20140828 zww add
                        //    }
                        //    prt4_midashi.picture2.Visible = true;
                        //    if (pic2.Equals(""))
                        //    {
                        //        prt4_midashi.picture2.Image = null;
                        //    }
                        //    else
                        //    {
                        //        prt4_midashi.picture2.Image = Image.FromFile(pic2);//20140828 zww add
                        //    }
                        //}
                        #endregion
                        ...
                        {
                            prt4_midashi.Run();
                            //frm.nMAXPAGE = prt4_midashi.nPAGECOUNT.ToString();
                        }

                        #region toDelete
                        //if (prt4_midashi.fNEWIMAGE == true)
                        //{
                        //    PRT_MITUMORI_TATE1IMAGE prtIMAGES = new PRT_MITUMORI_TATE1IMAGE();

                        //    if (frm.hyoushi == 1)//表紙がある場合は1plus
                        //    {
                        //        prtIMAGES.nPAGE = (prt4_midashi.nPAGECOUNT_1 + 1).ToString() + " / " + prt4_midashi.nPAGECOUNT.ToString();
                        //    }
                        //    else
                        //    {
                        //        prtIMAGES.nPAGE = prt4_midashi.nPAGECOUNT_1.ToString() + " / " + prt4_midashi.nPAGECOUNT.ToString();
                        //    }
                        ...
                        //    prtIMAGES.Run();
                        //    frm.prt01 = prtIMAGES;
                        //    prt4_midashi.Document.Pages.Add(prtIMAGES.Document.Pages[0]);
                        //    prtIMAGES.Dispose();
                        //    prtIMAGES = null;
                        //}
                        //else
                        ...
                        {
                            prt5_p1.Run();
                            //frm.nMAXPAGE = prt5_p1.nPAGECOUNT.ToString();
                        }
                        ...
                        if (fMIDASHI == true)
                        {
                            ...
                            if (fSYOUSAI == true)
                            {
                                for (int i = 0; i < prt5_p1.Document.Pages.Count; i++)
                                {
                                    prt4_midashi.Document.Pages.Add(prt5_p1.Document.Pages[i]);
                                }
                            }
                        ...
                        #region 見出し
                        mitsumori1 prt4_midashi1 = new mitsumori1(); // 纵向数据表 type1
                        prt4_midashi1.pcount = pcount;
                        prt4_midashi1.rmt_pcount1 = rmt_pcount1;
                        prt4_midashi1.flag_page1 = flag_page1;
                        prt4_midashi1.tokui_align = "中央";
                        prt4_midashi1.busyo_align = "中央";
                        prt4_midashi1.tantou_align = "";
                        prt4_midashi1.imagecheck = DDL_Logo.SelectedItem.ToString();
                        prt4_midashi1.HANKO_Check = "欄有り(担当印有り)";
                        prt4_midashi1.fSYOUSAI = false;//詳細チェック
                        prt4_midashi1.fICHIRAN = false;//一覧アンチェック
                        prt4_midashi1.fRYOUHOU = fSYOUSAI;
                        prt4_midashi1.fMIDASHI = fMIDASHI;//見出しチェック
                        prt4_midashi1.ckyoten = cKyoten;
                        prt4_midashi1.frogoimage = flagrogo;
                        ...
                        {
                            //frm.fZEINUKIKINNGAKU = true;
                            prt4_midashi1.fZEINUKIKINNGAKU = true;
                        }
                        else if (btnZeinuKingaku2.CssClass == "JC10ZeikomiBtnActive") //CB_ZEINUKIKINNGAKU2.Checked == true
                        {
                            //frm.fZEINUKIKINNGAKU = false;
                            prt4_midashi1.fZEINUKIKINNGAKU = false;
                        }
                        else
                        {
                            prt4_midashi1.fZEIFUKUMUKIKINNGAKU = true;
                        }

                        #region 纵向type1打印
                        prt4_midashi1.cMITUMORI = lblcMitumori.Text;
                        prt4_midashi1.picture1.Visible = false;
                        prt4_midashi1.picture2.Visible = false;
                        #region toDelete
                        //if (RB_TABLE.Checked)//数据表
                        //{
                        //    prt4_midashi1.picture1.Visible = false;
                        ...
                        //else if (RB_TABLE_PIC1.Checked)//为数据表+1张图片
                        //{
                        //    prt4_midashi1.picture1.Visible = true;
                        //    if (pic1.Equals(""))
                        //    {
                        //        //prt4.picture1.Image = null;
                        //        //20141120 如果图片1为空的话将图片2添加过来
                        //        if (pic2 != "")
                        //        {
                        //            prt4_midashi1.picture1.Image = Image.FromFile(pic2);
                        //        }
                        //        //..............end......
                        //    }
                        //    else
                        //    {
                        //        prt4_midashi1.picture1.Image = Image.FromFile(pic1);  //20140828 zww add
                        ...
                        //    if (pic1.Equals(""))
                        //    {
                        //        prt4_midashi1.picture1.Image = null;
                        //    }
                        //    else
                        //    {
                        //        prt4_midashi1.picture1.Image = Image.FromFile(pic1);//20140828 zww add
                        //    }
                        //    prt4_midashi1.picture2.Visible = true;
                        //    if (pic2.Equals(""))
                        //    {
                        //        prt4_midashi1.picture2.Image = null;
                        //    }
                        //    else
                        //    {
                        //        prt4_midashi1.picture2.Image = Image.FromFile(pic2);//20140828 zww add
                        //    }
                        //}
                        #endregion
                        if (fMIDASHI == true)
                        ...
                        #region toDelete
                        //if (prt4_midashi1.fNEWIMAGE == true)
                        //{
                        //    PRT_MITUMORI_TATE1IMAGE prtIMAGES = new PRT_MITUMORI_TATE1IMAGE();

                        //    if (frm.hyoushi == 1)//表紙がある場合は1plus
                        //    {
                        //        prtIMAGES.nPAGE = (prt4_midashi1.nPAGECOUNT_1 + 1).ToString() + " / " + prt4_midashi1.nPAGECOUNT.ToString();
                        //    }
                        //    else
                        //    {
                        //        prtIMAGES.nPAGE = prt4_midashi1.nPAGECOUNT_1.ToString() + " / " + prt4_midashi1.nPAGECOUNT.ToString();
                        //    }
                        ...
                        //    prtIMAGES.Run();
                        //    frm.prt01 = prtIMAGES;
                        //    prt4_midashi1.Document.Pages.Add(prtIMAGES.Document.Pages[0]);
                        //    prtIMAGES.Dispose();
                        //    prtIMAGES = null;
                        //}
                        //else
                        ...
                        if (fHYOUSHI==true)
                        {
                            rmt_pcount1 = (prt4_midashi.nPAGECOUNT + prt4_p1.nPAGECOUNT) - 1;//合計書数-表紙数
                        }
                        else
                        {
                            rmt_pcount1 = prt4_midashi.nPAGECOUNT + prt4_p1.nPAGECOUNT;//合計書数-表紙数
                        }
                    ...
                    else if (fMIDASHI == true && (fSYOUSAI == true && CHK_Meisai.Checked == false)) //見出し、明細かつ詳細
                    {
                        pcount = 0;
                        rmt_pcount1 = 0;
                    ...
                    else if (fMIDASHI == true && (fSYOUSAI == false && CHK_Meisai.Checked == true)) //見出し、明細かつ詳細
                    {
                        pcount = 0;
                        rmt_pcount1 = 0;
                    ...
                    else if (fMIDASHI == true && fSYOUSAI == false && CHK_Meisai.Checked == false) //見出し
                    {
                        pcount = 0;
                        rmt_pcount1 = 0;
                        flag_page1 = true;
                        ...
                        prt4.fRYOUHOU = false;
                        prt4.fMIDASHI = fMIDASHI;//見出しチェック
                        prt4.ckyoten = cKyoten;
                        prt4.frogoimage = flagrogo;
